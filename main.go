...
func main() {
	...
	if err := StartTestHTTPFs(port, callbacks); err != nil {
		log.Fatalf("Failed to start HTTPFs service: %v", err)
	}

	// log.Printf("HTTPFs service listening on port %d", port)
